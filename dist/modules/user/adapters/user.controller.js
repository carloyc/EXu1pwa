...
const get_all_users_interactor_1 = require("../use-cases/get-all-users.interactor");
class UserController {
    static getAll(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const repository = new user_storage_gateway_1.UserStorageGateway();
                const interactor = new get_all_users_interactor_1.GetAllUsersInteractor(repository);
